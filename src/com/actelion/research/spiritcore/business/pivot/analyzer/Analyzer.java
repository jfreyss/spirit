...
public class Analyzer {
	...
	public Analyzer(List<Result> results, SpiritUser user) {
		...
		LoggerFactory.getLogger(Analyzer.class).debug("Init analyzer: template calculated");
		table = new PivotDataTable(results, template);
		LoggerFactory.getLogger(Analyzer.class).debug("Init analyzer: table calculated");
	}
