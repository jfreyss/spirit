...
public class CreationLabel extends JComponentNoRepaint {
	...
	public Dimension getPreferredSize() {
		return date==null? new Dimension(65,25): new Dimension(getFontMetrics(FastFont.REGULAR).stringWidth( (user==null?"":user) + "__"+FormatterUtils.getLocaleFormat().getLocaleDateFormat()),25);
	}
