...
public class MoveLocationDlg extends JSpiritEscapeDialog {

	private List<Location> locations;
	private LocationBrowser locationBrowser = new LocationBrowser();

	public MoveLocationDlg(List<Location> myLocations) {
		super(UIUtils.getMainFrame(), "Move Location", MoveLocationDlg.class.getName());
		...
		okButton.addActionListener(e->eventOk());
