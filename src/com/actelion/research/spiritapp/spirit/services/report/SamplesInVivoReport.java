...
public class SamplesInVivoReport extends AbstractReport {
	...
	public SamplesInVivoReport() {		
		super(ReportCategory.SAMPLES, 
				"Samples Weighing (one table for all groups)", 
				"All organs are shown in the same sheet, additional sheets show the normalized values according to the last body weight, and the length of some organs", 
	...
	protected void populateWorkBook() throws Exception {		
		...
		List<String> lengthsList = new ArrayList<String>(lengthKeys);
		...
		for (int i = 0; i < 2+lengthsList.size(); i++) {
			...
			Map<Group, Map<String, String>> groupSampling2Range = new HashMap<Group, Map<String, String>>();
			for (Group group : study.getGroups()) {
				...
				Map<String, String> sampling2Range = new HashMap<String, String>();
				...
				for(String s: weighingKeys) {
					...
					animalRow = groupRow + 3;
					animalRows = new ArrayList<Integer>();
					for(Biosample animal: study.getTopAttachedBiosamples(group)) {						
	...
	public static void main(String[] args)  {
		try {
			...
			SamplesInVivoReport wg = new SamplesInVivoReport();
