 ...
 *
 */
public class BiotypeComboBox2 extends JGenericComboBox<Biotype> {

	public BiotypeComboBox2() {
		this("");
	}
	
	public BiotypeComboBox2(String label) {
		this(null, label);
	}
	public BiotypeComboBox2(Collection<Biotype> values) {
		this(values, "");
	}
	public BiotypeComboBox2(Collection<Biotype> values, String label) {
