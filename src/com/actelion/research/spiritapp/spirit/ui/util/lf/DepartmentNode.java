...
public class DepartmentNode extends ObjectComboBoxNode<EmployeeGroup> {
	public DepartmentNode(FormTree tree, Strategy<EmployeeGroup> strategy) {
		super(tree, "Department ", new EmployeeGroupComboBox(false), strategy);
	}
}
