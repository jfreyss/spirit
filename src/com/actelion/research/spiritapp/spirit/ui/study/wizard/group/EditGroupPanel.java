...
//		initialRadioButton.addActionListener(al);
		...
		divideSampleButton.addActionListener(new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent e) {
		...
		model1ComboBox.addActionListener(new ActionListener() {			
			@Override
			public void actionPerformed(ActionEvent e) {
				refreshLabel();
			}
...
//				new JLabel("Treatment Model: "), model2ComboBox, null
	...
	public void updateModel() throws Exception {
		...
		for(Group gr: dlg.getGroups()) { 
			if(gr!=group && shortGroup.equals(gr.getShortName())) {
				throw new Exception("The abbreviations must be unique");
			}
		}
		...
		//groups
//		if(initialRadioButton.isSelected()) {
//			group.setFromPhase(initialPhaseComboBox.getSelection());
