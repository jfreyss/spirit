...
public class StudyTreatmentDlg extends JEscapeDialog {
	...
	private JCustomTextField doseTextField1 = new JCustomTextField(5, "");
	...
	private JCustomTextField doseTextField2 = new JCustomTextField(5, "");
	...
	public StudyTreatmentDlg(final Study study, NamedTreatment namedTreatment) {
		...
		JPanel centerPanel = UIUtils.createBox(
				UIUtils.createTitleBox("", UIUtils.createTable(
				...
				UIUtils.createVerticalBox(
						...
						UIUtils.createTitleBox("Compound 2", UIUtils.createVerticalBox(
								UIUtils.createTable(
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ev) {
				try {
					...
					if(((String)applicationComboBox2.getSelection())!=null || unitComboBox2.getSelection()!=null || doseTextField2.getTextDouble()!=null) {
